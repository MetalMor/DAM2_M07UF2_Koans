...
namespace TheKoans
{
	...
	public class K050_AboutControlStatements : KoanHelper
	{
		...
		public void IfThenElseStatementsWithoutBrackets ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, b, "A no ser que l'statement fos un 'break', un 'continue' o un 'return', jo sempre utilitzaria els corxets per evitar confusions.");
		...
		public void IfThenStatementsWithBrackets ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, b, "Un bon dia, un hacker em va dir: 'brackets do not cause a racket'. Ens donen més claredat i potencial pels futurs statements.");
		...
		public void IfThenStatementsWithoutBrackets ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, b, "El codi pot semblar més net sense ells, però els corxets ens ajudaran a evitar confusions.");
		...
		public void WhyItIsWiseToAlwaysUseBrackets ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, b1, "Indentar sovint farà que el vostre codi sigui més llegible, però només quan ho feu de manera correcta!");
            ...
            //Assert.AreEqual (FILL_ME_IN, b2, "L'espai en blanc no sempre serà el vostre amic... Prepareu-vos!");
		...
		{
            //Assert.AreEqual (FILL_ME_IN, (true ? 1 : 0), "Ha arribat el vostre tern, petites llagostes, de triar el valor apropiat..");
            Assert.AreEqual(1, (true ? 1 : 0), "Ha arribat el vostre tern, petites llagostes, de triar el valor apropiat..");
            //Assert.AreEqual (FILL_ME_IN, (false ? 1 : 0), "O potser hi podeu ternar a intentar aquí fins que trieu correctament?");
            Assert.AreEqual(0, (false ? 1 : 0), "O potser hi podeu ternar a intentar aquí fins que trieu correctament?");
        }
		...
		public void NullableTypes ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, i == null, "Això té el mateix efecte que utilitzar: int i = new int();");
            Assert.AreEqual(false, i == null, "Això té el mateix efecte que utilitzar: int i = new int();");
            //Assert.AreEqual (FILL_ME_IN, nullableInt == null, "Es fa estrany veure 'int'? -- com si el programador no n'estigués segur -- doncs ja es tracta d'això home!!!");
		...
		public void AssignIfNullOperator ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, x, "Esbrinar això és com intentar esbrinar el sentit de la vida...");
		...
		public void IsOperators ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, isAboutMethods, "Com a bon booleà, us donarà dues oportunitats de fer aquest correctament.");
            Assert.AreEqual(false, isAboutMethods, "Com a bon booleà, us donarà dues oportunitats de fer aquest correctament.");
            //Assert.AreEqual(FILL_ME_IN, isKoan, "Com a Koan, no és qüestió de fer aquest correctament, sinó d'aprendre.");
            Assert.AreEqual(true, isKoan, "Com a Koan, no és qüestió de fer aquest correctament, sinó d'aprendre.");
            //Assert.AreEqual (FILL_ME_IN, isAboutControlStatements, "Com a qüestió implícita en l'aprenentatge, sempre hi ha d'haver l'opció d'aprendre més.");
		...
		public void WhileStatement ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, result, "Si aquest fos uns quants segles més jove, aquest mètode podria ser un WhilstStatement.");
            Assert.AreEqual(120, result, "Si aquest fos uns quants segles més jove, aquest mètode podria ser un WhilstStatement.");
        }
		...
		public void DoWhileStatement ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, result, "Lògicament, aquest té més sentit per mi. Un ha de fer feina primer per saber quan s'ha de parar.");
            Assert.AreEqual(120, result, "Lògicament, aquest té més sentit per mi. Un ha de fer feina primer per saber quan s'ha de parar.");
        }
		...
		public void ContinueStatement ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, result, "No deixeu que les matemàtiques espantin el vostre Karma... Persevereu!");
            Assert.AreEqual(25, result, "No deixeu que les matemàtiques espantin el vostre Karma... Persevereu!");
        }
		...
		public void ForStatement ()
		{
            ...
            //CollectionAssert.AreEqual (new[] { FILL_ME_IN }, list, "Convertir els valors mentre els parsegem sona perillós, eh?");
		...
		public void ForEachStatement ()
		{
            ...
            //CollectionAssert.AreEqual (new[] { FILL_ME_IN }, list, "Tal i com les dades van, això només necessita una mica de maionesa.");
            ...
            //CollectionAssert.AreEqual (new[] { FILL_ME_IN }, finalList, "HE DIT, 'TAL I COM LA DADES VAN, AIXÒ NOMÉS NECESSITA UNA MICA DE MAIONESA!'");
		...
		public void ModifyingACollectionDuringForEach ()
		{
			...
			try {
                ...
                //Assert.AreEqual (typeof(FILL_ME_IN), ex.GetType (), "Putinejant la col·lecció durant una enumeració foreach no sembla correcte... per no dir prohibit.");
                Assert.AreEqual(typeof(InvalidOperationException), ex.GetType(), "Putinejant la col·lecció durant una enumeració foreach no sembla correcte... per no dir prohibit.");
            }
        }
		...
		public void CatchingModificationExceptions ()
		{
            ...
            //Assert.AreEqual (FILL_ME_IN, whoCaughtTheException, "Si podeu solucionar aquest misteri whodunit, el vostre karma C# us ho agrairà.");
